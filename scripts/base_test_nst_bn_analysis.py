    ...
    def get_performance(self, dataloader, trainloader, city):
        ...
        for i, sample in enumerate(tbar):
            ...
            for h in self.model.modules():
                if isinstance(h, nn.Conv2d): #this is ok to do, since there is one conv2d layer corresponding to each BN layer.
            ...
            pickle.dump(bn,open(os.path.join(dirname, 'bnAll_after.pickle'),'wb'));
            break
