...
class Test:
    ...
    def get_performance(self, dataloader, trainloader, city, adabn_layer,model):
        ...
        #    pickle.dump(bn,open(os.path.join(dirname, 'bnAll_after_{}_{}_{}.pickle'.format(converged_model.rstrip('.pth'), self.sample_number, adabn_layer)),'wb')); #self.trial
        #    break
    ...
    def test(self, name, converged_model):
        ...
        i_all=[]
        for l in range(0,113,1): #in range(1,61,1):#(10,61,10):
            tA, tI, tIm = [], [], []
            ...
            i_all.append(tI[0])
            name_f = '{}/{}_adabn.pickle'.format(name,city)
